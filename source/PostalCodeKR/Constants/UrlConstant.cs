...
public class UrlConstant
{
    ...
    public const string SearchKeywordQueryPoint = "srchwrd";
    public const string CountPerPageQueryPoint = "countPerPage";
    public const string CurrentPageQueryPoint = "currentPage";
}
